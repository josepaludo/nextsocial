...
export default function ThumbsPostUpAndDown(
    {className, postId, likesTotal, userVote}: ThumbsPostUpAndDownType
) {
    ...
    function voteUpOrDown(likeValue: LikeValue) {
        axios.post('/api/app/votepost', {postId, likeValue})
